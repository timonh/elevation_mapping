 ...
 */
class HighGrassElevationMapping
{
 public:
   ...
   */
  HighGrassElevationMapping(ros::NodeHandle& nodeHandle);

  /*!
   * Destructor.
   */
  ~HighGrassElevationMapping();
   ...
   */
  void highGrassPointCloudCallback(const sensor_msgs::PointCloud2& pointCloud);

  /*!
   * Callback function for the foot tip positions when the feet are touching the ground.
   */
